...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\Type\\ParticipantType' => function () {
    return ($this->privates['App\Form\Type\ParticipantType'] ?? $this->privates['App\Form\Type\ParticipantType'] = new \App\Form\Type\ParticipantType());
}, 'App\\Form\\Type\\PartyType' => function () {
    return ($this->privates['App\Form\Type\PartyType'] ?? $this->privates['App\Form\Type\PartyType'] = new \App\Form\Type\PartyType());
