...
// Returns the private 'App\Repository\KillerPartyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\KillerPartyRepository.php';

return $this->privates['App\Repository\KillerPartyRepository'] = new \App\Repository\KillerPartyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
