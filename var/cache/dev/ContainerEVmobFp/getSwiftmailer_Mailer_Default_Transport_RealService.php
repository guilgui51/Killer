...
return $this->services['swiftmailer.mailer.default.transport.real'] = \Symfony\Bundle\SwiftmailerBundle\DependencyInjection\SwiftmailerTransportFactory::createTransport(array('transport' => 'smtp', 'url' => $this->getEnv('MAILER_URL'), 'username' => 'adminkiller@ckngf.fr', 'password' => 'Gs17020502', 'host' => 'ssl0.ovh.net', 'port' => 587, 'timeout' => 30, 'source_ip' => NULL, 'local_domain' => NULL, 'encryption' => NULL, 'auth_mode' => 'login', 'command' => '/usr/sbin/sendmail -bs'), ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()), ($this->privates['swiftmailer.mailer.default.transport.eventdispatcher'] ?? $this->privates['swiftmailer.mailer.default.transport.eventdispatcher'] = new \Swift_Events_SimpleEventDispatcher()));
