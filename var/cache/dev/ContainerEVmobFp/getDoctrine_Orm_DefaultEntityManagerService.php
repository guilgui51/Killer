...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\KillerPartyRepository' => function () {
    return ($this->privates['App\Repository\KillerPartyRepository'] ?? $this->load('getKillerPartyRepositoryService.php'));
}, 'App\\Repository\\MissionRepository' => function () {
    return ($this->privates['App\Repository\MissionRepository'] ?? $this->load('getMissionRepositoryService.php'));
}, 'App\\Repository\\ParticipantRepository' => function () {
    return ($this->privates['App\Repository\ParticipantRepository'] ?? $this->load('getParticipantRepositoryService.php'));
