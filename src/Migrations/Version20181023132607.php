 ...
 */
final class Version20181023132607 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__killer_party AS SELECT id, starting_date, name, uid, is_over FROM killer_party');
        ...
        $this->addSql('INSERT INTO killer_party (id, starting_date, name, uid, is_over) SELECT id, starting_date, name, uid, is_over FROM __temp__killer_party');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__killer_party AS SELECT id, starting_date, name, uid, is_over FROM killer_party');
        $this->addSql('DROP TABLE killer_party');
        $this->addSql('CREATE TABLE killer_party (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, starting_date DATETIME NOT NULL, name VARCHAR(255) NOT NULL, uid VARCHAR(255) NOT NULL, is_over BOOLEAN DEFAULT NULL)');
        $this->addSql('INSERT INTO killer_party (id, starting_date, name, uid, is_over) SELECT id, starting_date, name, uid, is_over FROM __temp__killer_party');
        $this->addSql('DROP TABLE __temp__killer_party');
        $this->addSql('DROP INDEX UNIQ_D79F6B11158E0B66');
        $this->addSql('DROP INDEX IDX_D79F6B11213C1059');
